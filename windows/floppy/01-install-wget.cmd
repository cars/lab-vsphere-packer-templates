...
REM if not defined WGET_URL set WGET_URL=https://eternallybored.org/misc/wget/current/wget.exe
 if not defined WGET_URL set WGET_URL=http://10.0.0.48/wget/wget.exe
